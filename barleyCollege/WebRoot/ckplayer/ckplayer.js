...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        advmarquee: escape('{a href="http://www.ckplayer.com"}{font color="#FFFFFF" size="12" face="Microsoft YaHei"}这里可以放文字广告，播放器默认使用。{/font}{/a}'),
    /*
		...
		*/
        cpt_lights: '1',
		/*
		该处定义是否使用开关灯，使用开灯效果时调用页面的js函数function openlights(){}，关灯调用 function closelights(){};
		*/
